...
def show_photoelectron_image_histogram(simtel_file_path, tel_num, event_id, channel=0, quiet=False):
    ...
    plt.savefig('TEL{:03d}_EV{:05d}_CH{:03d}_pe_hist.png'.format(tel_num, event_id, channel))
...
if __name__ == '__main__':
    ...
    show_photoelectron_image_histogram(simtel_file_path, tel_num, event_id, channel, quiet)
