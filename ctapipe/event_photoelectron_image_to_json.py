...
def get_photoelectron_image_array(simtel_file_path, tel_num, event_id, channel=0):
    ...
    image = event.mc.tel[tel_num].photo_electrons
...
if __name__ == '__main__':
    ...
    file_name = "CT{:03d}_EV{:05d}_CH{:03d}_PE.json".format(tel_num, event_id, channel)
