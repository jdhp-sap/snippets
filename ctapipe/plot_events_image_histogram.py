...
if __name__ == '__main__':
    ...
    if args.output is None:
        output_file_path = "TEL{:03d}_EV{:05d}_CH{:03d}_HIST.pdf".format(tel_num, event_id, channel)
    else:
        output_file_path = args.output

    # DISPLAY IMAGES ##########################################################

    show_image_histogram(simtel_file_path, output_file_path, tel_num, event_id, channel, quiet)
